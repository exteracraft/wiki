...
::: details Не стройте автоматические фермы и не делайте большие скопления мобов в мире построек
![](src/features/worlds/farm/farmworld.png)
...
::: details Не используйте ники и скины, которые совпадают, похожи или пародируют ники других игроков сервера
#### Скины
...
::: warning Наказание за похожий ник
